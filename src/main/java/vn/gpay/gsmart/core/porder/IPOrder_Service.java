...
public interface IPOrder_Service extends Operations<POrder> {
	...
	List<POrder> get_free_bygolivedate(Date golivedate_from, Date golivedate_to, Long granttoorgid_link,String PO_code,Long orgbuyerid_link,Long orgvendorid_link, List<Long> vendors, List<Long> buyers);
