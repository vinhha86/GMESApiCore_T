...
public class PContractProductBomBinding {
	...
	public Float getAmount_color() {
		return amount_color;
	}
	public void setAmount_color(Float amount_color) {
	...
	public void setThanhPhanVai(String thanhPhanVai) {
		this.thanhPhanVai = thanhPhanVai;
	}
