...
public interface IPOrderBOMSKU_Service extends Operations<POrderBOMSKU>{
	...
	List<POrderBOMSKU> getby_pcontract_product_and_material_and_sku_and_type(Long pcontractid_link, Long productid_link,Long materialid_link, long skuid_link, int type);
