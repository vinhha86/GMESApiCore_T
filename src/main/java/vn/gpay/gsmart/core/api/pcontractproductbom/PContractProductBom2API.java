...
//			List<Long> List_size = ppatt_service.getvalueid_by_product_and_pcontract_and_attribute(orgrootid_link, pcontractid_link, productid_link, (long) 30);
			...
			for (PContractProductBom2 pContractProductBom : listbom) {
				Runnable bom2 = new PContractProductBom2_Runnable(productid_link, pcontractid_link, pContractProductBom, list_colorid, List_size, listbomsku, listdata, po_npl_Service, 
						avService, ppbom2skuservice);
...
//	private static class PContractProductBom2_Runnable implements Runnable{
...
//		
//		PContractProductBom2_Runnable(Long productid_link, Long pcontractid_link, PContractProductBom2 pContractProductBom, List<Long> list_colorid, List<Long> List_size,
