...
//			long orgrootid_link = user.getRootorgid_link();
			...
			List<POrderBomProduct> listbom = porderbomproductService.getby_porder(porderid_link);
			List<POrderBOMSKU> listbomsku = porderbomskuService.getByPOrderID_and_type(porderid_link,
					POrderBomType.CanDoi);
			List<POrderBOMSKU> listbomsku_kythuat = porderbomskuService.getByPOrderID_and_type(porderid_link,
					POrderBomType.Kythuat);
			List<POrderBOMSKU> listbomsku_sanxuat = porderbomskuService.getByPOrderID_and_type(porderid_link,
