...
public class POrderAPI {
	...
	public ResponseEntity<POrderResponse> get_free_bygolivedate(HttpServletRequest request,
		...
		try {
			...
			List<POrder> lsPOrder = porderService.get_free_bygolivedate(entity.golivedate_from, entity.golivedate_to, orgid_link, false);
			...
			for(Org theOrg:lsOrgChild){
				lsPOrder.addAll(porderService.get_free_bygolivedate(entity.golivedate_from, entity.golivedate_to, theOrg.getId(), false));
			}
