...
public class ScheduleOrgGrant implements Runnable{
	...
	ScheduleOrgGrant(
			Schedule_plan sch_org_grant,
			Schedule_plan sch_process,
			Schedule_plan sch_estimation,
			Org org_grant,
			Date startdate,
			Date toDate,
			String PO_code,
			String contractcode,
			long orgbuyerid_link,
			long orgvendorid_link,
			long orgid,
			long orgrootid_link,
			List<Schedule_porder> rows_grant,
