...
public class TimesheetShiftTypeAPI {
	...
	//lay tất cả các ca làm việc chưa có trong đơn vị quản lý
		...
		public ResponseEntity<TimesheetShiftType_load_response> getTimesheetshifttype_ByIdOrg(@RequestBody Timesheetshift_load_byIdOrg entity) {
			TimesheetShiftType_load_response response = new TimesheetShiftType_load_response();
			try {
	...
	//xóa ca làm việc
		...
		public ResponseEntity<ResponseBase> delete_timesheetshifttype(@RequestBody  TimesheetShiftType_delete_request entity) {
			ResponseBase response = new ResponseBase();
			try {
